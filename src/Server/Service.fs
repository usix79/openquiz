...
module Main =
        ...
        let exPublisher proc f =
            ...
            let ff f = (fun expertId req ->
                ...
                | Some expert ->
                    f expert req
                | None ->
                    Log.Error ("{Op} {Error} {ExpertId}", "createQuiz", "Wrong Publisher Id", expertId)
    ...
    let updateProdQuizCard expert card =
        ...
        | Some quiz ->
            ...
            Ok {|Record = updatedQuiz.Dsc |> Main.quizProdRecord; Card = Main.quizProdCard updatedQuiz; |}
    ...
    let private createTeam exp quiz teamName : Result<Domain.Team,string> =
        let createTransaction () =
            let teamId = (Data.Teams.getMaxId quiz.QuizId) + 1
            let team = Domain.Teams.createNew teamId teamName quiz
            Data.Teams.update team

        result {
            let teamsInQuiz = Data.Teams.getDescriptors quiz.QuizId

            do! Domain.Teams.validatePublicTeamUpdate true teamName teamsInQuiz quiz

            let team = lock _teamsLockObj createTransaction
    ...
    let private updateTeam quiz team teamName : Result<Domain.Team,string> =
        ...
        | false ->
            result{
                ...
                do! Domain.Teams.validatePublicTeamUpdate false teamName teamsInQuiz quiz

                return
                    team
                    |> Domain.Teams.changeName teamName
                    |> Data.Teams.update
            }
    ...
    let updateProdPackageCard expert card =
        ...
        | Some pkg ->
            ...
            Ok {|Record = updatedPkg.Dsc |> Main.packageProdRecord; Card = Main.packageProdCard updatedPkg; |}
