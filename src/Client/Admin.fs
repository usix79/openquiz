...
let view (dispatch: Msg -> unit) (user: AdminUser) (settings: Settings) (model: Model) =
    section
        [ Class "hero is-shadowless is-fullheight is-light" ]
        [ div
              [ Class "hero-head" ]
              [ div
                    [ Class "container" ]
                    [ nav
                          ...
                          [ div
                                [ Class "navbar-brand" ]
                                [ a
                                      [ Class "navbar-item"; Style [ MarginRight "auto" ] ]
                                      [ let imgSrc =
                                            Infra.urlForMediaOrDefault
                                                settings.MediaHost
                                                user.QuizImg
                                                Infra.defaultMediaImg
                            ...
                            a
                                [ classList
                                      [ "navbar-item", true
                                        ...
                                        | Teams _ -> true
                                        | _ -> false ]
                                  OnClick(fun _ -> dispatch SwitchToTeams) ]
                                [ str "Teams" ]
                            a
                                [ classList
                                      [ "navbar-item", true
                                        ...
                                        | CP _ -> true
                                        | _ -> false ]
                                  OnClick(fun _ -> dispatch SwitchToCP) ]
                                [ str "Control Panel" ]
                            a
                                [ classList
                                      [ "navbar-item", true
                                        ...
                                        | Answers _ -> true
                                        | _ -> false ]
                                  OnClick(fun _ -> dispatch SwitchToAnswers) ]
                                [ str "Answers" ]
                            a
                                [ classList
                                      [ "navbar-item", true
                                        ...
                                        | Results _ -> true
                                        | _ -> false ]
                                  OnClick(fun _ -> dispatch SwitchToResults) ]
                                [ str "Results" ] ] ] ]
          div
              [ Class "hero-body" ]
              [ div
          ...
          div
              [ Class "hero-foot has-background-dark has-text-grey-light" ]
              [ div
